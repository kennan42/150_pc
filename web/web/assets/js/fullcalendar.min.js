...
(function(t){
 ...
 : t.isFunction(e) || (n = e + "", e = function(t){
                return t._id == n
            }), O = t.grep(O, e, !0), r = 0; _.length > r; r++) 
                t.isArray(_[r].events) && (_[r].events = t.grep(_[r].events, e, !0));
            M(O)
        }
        function m(e){
        ...
        var E, S, k = C.trigger, x = C.getView, M = C.reportEvents, z = C.getEventEnd, R = {
            events: []
        }, _ = [R], H = 0, F = 0, A = 0, O = [];
    ...
    function J(e, n, r){
        ...
        function c(){
            ...
            for (r += "<thead><tr>", oe && (r += "<th class='fc-week-number " + n + "'>" + R(ie("weekNumberTitle")) + "</th>"), t = 0; G > t; t++) 
                e = ue(0, t), r += "<th class='fc-day-header fc-" + Ae[e.day()] + " " + n + "'>" + R(he(e, ae)) + "</th>";
            return r += "</tr></thead>"
        }
        function d(){
    ...
    function ae(n, r, a){
        ...
        function d(){
            ...
            for (a += "<thead><tr>", Le("weekNumbers") ? (t = Ve(0, 0), e = Qe(t), Ne ? e += Le("weekNumberTitle") : e = Le("weekNumberTitle") + e, a += "<th class='fc-agenda-axis fc-week-number " + r + "'>" + R(e) + "</th>") : a += "<th class='fc-agenda-axis " + r + "'>&nbsp;</th>", n = 0; xe > n; n++) 
                t = Ve(0, n), a += "<th class='fc-" + Ae[t.day()] + " fc-col" + n + " " + r + "'>" + R(Ge(t, We)) + "</th>";
        ...
        function u(){
            ...
            for (c += "<tbody><tr><th class='fc-agenda-axis " + i + "'>&nbsp;</th>", n = "", e = 0; xe > e; e++) 
                t = Ve(0, e), o = ["fc-col" + e, "fc-" + Ae[t.day()], s], t.isSame(l, "day") ? o.push(Fe + "-state-highlight", "fc-today") : l > t ? o.push("fc-past") : o.push("fc-future"), a = "<td class='" + o.join(" ") + "'>" + "<div>" + "<div class='fc-day-content'>" + "<div style='position:relative'>&nbsp;</div>" + "</div>" + "</div>" + "</td>", n += a;
